...
export default function PricingPage() {
  ...
  const plans = [
    {
      name: "Starter",
      code: "STARTER_ANNUALLY",
      price: "₹18k-30k",
      period: "/year",
      description: "Best for: 5–30 employees | Target: Essential HR Operations",
      features: [
        "Role-based Access",
    ...
    {
      name: "Professional",
      code: "PROFESSIONAL_ANNUALLY",
      price: "₹60k-1.2L",
      period: "/year",
      description: "Best for: 30–200 employees | Target: Automated & Integrated Workflows",
      features: [
    ...
    },
    {
      ...
      price: "₹2.5L-10L+",
      period: "/year",
      description: "Best for: 200+ employees | Target: Customization, Compliance & Scale",
      features: [
        "All Professional features",
        "Multi-tenant / Company Architecture",
        "SSO (Google/Microsoft) & AD Sync",
        "Custom Workflows & Modules",
        "ERP / Accounting Sync",
        "AI HR Assistant & Predictive Analytics",
        "Compliance Reports & Webhooks",
